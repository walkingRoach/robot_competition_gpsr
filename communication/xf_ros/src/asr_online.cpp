...
static const char*  session_begin_params    =   "sub = asr, result_type = xml, result_encoding = UTF-8,sample_rate = 8000,aue = speex-wb";
...
int main(int argc, char* argv[])
{
    ...
    int         ret                     =   MSP_SUCCESS;
    const char* login_params            =   "appid = 59a4c2a0, work_dir = .";
    ...
    printf("上传语法 ...\n");
    ret = get_grammar_id("/home/lennon/home_ws/src/xf_ros/cfg/home_final.abnf", grammar_id, GRAMID_LEN);
    if (MSP_SUCCESS != ret)
        goto exit;
    printf("上传语法成功\n");
