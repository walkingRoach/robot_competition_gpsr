 ...
 *     cdef obj_detect __pyx_PickleError
 *     cdef obj_detect __pyx_result
 */
 ...
 */
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "obj_detect of type 'NoneType' has no len()");
 ...
 */
    ...
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (unlikely(__pyx_v___pyx_state == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' obj_detect is not subscriptable");
 ...
 */
  ...
  /* "EnumBase":9
 * 
 * cdef obj_detect __Pyx_OrderedDict
 * if PY_VERSION_HEX >= 0x02070000:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "EnumBase":26
 * 
 * cdef obj_detect __Pyx_EnumBase
 * class __Pyx_EnumBase(int):             # <<<<<<<<<<<<<<
 *     __metaclass__ = __Pyx_EnumMeta
 *     def __new__(cls, value, name=None):
 */
...
static PyObject *__Pyx_PyFunction_FastCallDict(PyObject *func, PyObject **args, Py_ssize_t nargs, PyObject *kwargs) {
    ...
    if (Py_EnterRecursiveCall((char*)" while calling a Python obj_detect")) {
        return NULL;
    }
    if (
#if PY_MAJOR_VERSION >= 3
...
static CYTHON_INLINE PyObject* __Pyx_PyObject_Call(PyObject *func, PyObject *arg, PyObject *kw) {
    ...
    if (unlikely(Py_EnterRecursiveCall((char*)" while calling a Python obj_detect")))
        return NULL;
...
static PyObject *__Pyx_PyObject_GetIndex(PyObject *obj, PyObject* index) {
    ...
    if (unlikely(!(m && m->sq_item))) {
        PyErr_Format(PyExc_TypeError, "'%.200s' obj_detect is not subscriptable", Py_TYPE(obj)->tp_name);
        return NULL;
    }
...
#if PY_MAJOR_VERSION >= 3
                 "'%.50s' obj_detect has no attribute '%U'",
                 tp->tp_name, attr_name);
#else
                 "'%.50s' obj_detect has no attribute '%.400s'",
...
static PyTypeObject* __Pyx_FetchCommonType(PyTypeObject* type) {
    ...
    if (cached_type) {
        if (!PyType_Check((PyObject*)cached_type)) {
            PyErr_Format(PyExc_TypeError,
                "Shared Cython type %.200s is not a type obj_detect",
                type->tp_name);
            goto bad;
        }
...
__Pyx_CyFunction_set_name(__pyx_CyFunctionObject *op, PyObject *value, CYTHON_UNUSED void *context)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError,
                        "__name__ must be set to a string obj_detect");
        return -1;
    }
    tmp = op->func_name;
    Py_INCREF(value);
...
__Pyx_CyFunction_set_qualname(__pyx_CyFunctionObject *op, PyObject *value, CYTHON_UNUSED void *context)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError,
                        "__qualname__ must be set to a string obj_detect");
        return -1;
    }
...
__Pyx_CyFunction_set_defaults(__pyx_CyFunctionObject *op, PyObject* value, CYTHON_UNUSED void *context) {
    ...
    if (!value) {
        ...
        PyErr_SetString(PyExc_TypeError,
                        "__defaults__ must be set to a tuple obj_detect");
        return -1;
    }
    Py_INCREF(value);
...
__Pyx_CyFunction_set_kwdefaults(__pyx_CyFunctionObject *op, PyObject* value, CYTHON_UNUSED void *context) {
    ...
    if (!value) {
        ...
        PyErr_SetString(PyExc_TypeError,
                        "__kwdefaults__ must be set to a dict obj_detect");
        return -1;
    }
    Py_INCREF(value);
...
__Pyx_CyFunction_set_annotations(__pyx_CyFunctionObject *op, PyObject* value, CYTHON_UNUSED void *context) {
    ...
    if (!value || value == Py_None) {
        ...
        PyErr_SetString(PyExc_TypeError,
                        "__annotations__ must be set to a dict obj_detect");
        return -1;
    }
    Py_XINCREF(value);
